...
public class DataSource implements DataSourceService{
    ...
    private final HashMap<Integer, BookDetailsModel>bookDetails=new HashMap<>();
    private final HashMap<Integer,BookDatesModel>bookDates=new HashMap<>();
    private final HashMap<Integer, BookPagesModel>bookPages=new HashMap<>();
    private final HashMap<Integer, BookAuthorModel>bookAuthors=new HashMap<>();
    private final HashMap<Integer,StudentAccountModel>borrowerDetails=new HashMap<>();
    private final HashMap<String, LibrarianAccountModel>librarianDetails=new HashMap<>();
    private final HashMap<String, StudentAccountModel>studentDetails=new HashMap<>();
    private DataSource(){
