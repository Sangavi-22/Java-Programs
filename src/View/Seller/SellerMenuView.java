        ...
        try {
            ...
            switch (SellerActions.values()[userChoice - 1]) {
                ...
                case ADD_PRODUCTS:
                    ...
                    if(shopController.addPhone(phoneDetailsModel, phoneCameraModel, phoneDimensionsModel, phoneManufacturerModel, phoneProcessorModel, phoneView, printPhoneInfoView)==1) {
                        System.out.println("Phone added successfully");
                        System.out.println("******************END OF ADD PRODUCTS******************");
                        System.out.println();
                    }
                    else if(shopController.addPhone(phoneDetailsModel, phoneCameraModel, phoneDimensionsModel, phoneManufacturerModel, phoneProcessorModel, phoneView, printPhoneInfoView)==2)
                    {
                ...
                case REMOVE_PRODUCTS:
                    ...
                    System.out.println("****************END OF REMOVE PRODUCTS*****************");
                    System.out.println();
                    sellerMenu();
                    break;
                ...
                case CHECK_STOCK:
                    System.out.println("*******************************************************");
                    System.out.println("!          STOCK NOT AVAILABLE PRODUCTS LIST          !");
                    System.out.println("*******************************************************");
